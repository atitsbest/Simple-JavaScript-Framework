var Control = new Class(/** @lends Control# */{
   ...
   */
  findControl: function(/**String*/id) /**Control*/ {
    // Selber?
    if (this.id == id)
      return this;
   ...
   * @returns {Control[]} [] wenn keine Controlls gefunden wurden.
   */
  findControls: function(/**Regex*/pattern) /**Control[]*/ {
   ...
   * @returns {Control[]} [] wenn keine Controls gefunden wurden.
   */
  _findControls: function(/**Regex*/pattern, /**String*/member) /**Control[]*/ {
    var result = [];
  ...
  _initializeControl: function(e, callback) {
    ...
    // Instanz erstellen.
    result = (entryIndex != -1) 
      ? Control._factories[entryIndex].factory.create($e, settings)
 ...
 */
Control.registerFactory = function(/**Regex*/typePattern, /**Object*/factory) {
  Control._factories.push({
    type: typePattern,
    factory: factory
  });
}		
